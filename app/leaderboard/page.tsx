                  ...
                  <tr key={p.uuid} onClick={() => window.location.href = `/player/${p.uuid}`} style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', transition: 'background-color 0.2s', cursor: 'pointer' }} className="hover-row">
                    ...
                    <td style={{ padding: '1rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        <img src={`https://mc-heads.net/avatar/${p.uuid}/256`} alt={p.name} style={{ width: '32px', height: '32px', borderRadius: '0.375rem', border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(0,0,0,0.5)' }} crossOrigin="anonymous" />
