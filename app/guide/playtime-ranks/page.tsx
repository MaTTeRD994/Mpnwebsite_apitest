        ...
        {PLAYTIME_RANKS.map((rank, idx) => (
          <div key={idx} style={{ background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "8px", padding: "1.5rem", position: "relative" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid rgba(255,255,255,0.05)", paddingBottom: "1rem", marginBottom: "1rem" }}>
              <span style={{ background: "rgba(0,0,0,0.5)", border: `1px solid ${rank.color}33`, padding: "0.25rem 0.75rem", borderRadius: "4px", fontSize: "0.75rem", fontWeight: "bold", color: rank.color, textTransform: "uppercase", letterSpacing: "1px" }}>
                {rank.name}
              </span>
              <div style={{ textAlign: "right" }}>
                <div style={{ fontSize: "2.5rem", fontWeight: "bold", lineHeight: 1, textShadow: "0 2px 4px rgba(0,0,0,0.5)" }}>{rank.hours}</div>
                <div style={{ fontSize: "0.6rem", color: "var(--primary)", fontWeight: "bold", textTransform: "uppercase", letterSpacing: "1px" }}>Hours Played</div>
              </div>
            </div>
            ...
            {rank.specialDiscord && (
              <div style={{ marginTop: "1.5rem", padding: "0.75rem", background: "rgba(242, 169, 60, 0.1)", border: "1px solid rgba(242, 169, 60, 0.3)", borderRadius: "4px", textAlign: "center", color: "var(--gold)", fontSize: "0.8rem", fontWeight: "bold", textTransform: "uppercase", letterSpacing: "1px" }}>
                Special Discord Access
              </div>
            )}
